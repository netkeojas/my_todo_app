...
import 'package:mytodoapp_client/src/protocol/todo.dart' as _i3;
...
class _EndpointTodo extends _i1.EndpointRef {
  ...
  _i2.Future<bool> createTodo(_i3.Todo todo) => caller.callServerEndpoint<bool>(
        'todo',
        'createTodo',
        {'todo': todo},
      );

  _i2.Future<List<_i3.Todo>> readTodo() =>
  ...
  _i2.Future<bool> updateTodo(_i3.Todo todo) => caller.callServerEndpoint<bool>(
        'todo',
        'updateTodo',
        {'todo': todo},
      );
  ...
  _i2.Future<_i3.Todo?> readTodoById(int id) =>
